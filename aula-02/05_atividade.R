...
### # ###
paste("O aluno alu201830194 realizou ", acessos_alunos$alu201830194, " acessos.")
...
### # ###
varCompar <- acessos > acessos_alunos$alu201830194
alunos_mais_acessos <- acessos[varCompar]
paste("Quantidade de alunos com mais acesso: ", length(alunos_mais_acessos))


### 5 ###
## Combine todas as etapas acima em uma única chamada, sem a criação dos vetores auxiliares
### # ###
paste("Quantidade de alunos com mais acesso: ",length(acessos[acessos > acessos_alunos$alu201830194]))
...
### # ###
paste("Quantidade de alunos com menos acesso: ", sum(acessos < acessos_alunos$alu201830194))
...
### # ###
notas_aluno <- unlist(acessos_alunos, use.names = FALSE)
notas_aluno[which(notas_aluno > 0 & notas_aluno < 10)] <- 1
notas_aluno[which(notas_aluno >= 10)] <- 2
...
varComparEx9 <- acessosEx9 > acessos_alunos_e_guest$alu201830194
alunos_com_mais_acessosEx9 <- acessosEx9[varComparEx9]
paste("Quantidade de alunos com mais acesso: ", length(alunos_com_mais_acessosEx9))

# 5
paste("Quantidade de alunos com mais acesso: ",length(acessosEx9[acessosEx9 > acessos_alunos_e_guest$alu201830194]))

# 6
paste("Quantidade de alunos com menos acessos: ", sum(acessosEx9 < acessos_alunos_e_guest$alu201830194))
